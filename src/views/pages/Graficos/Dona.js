...
const Dona = () => {
  ...
  const [objetivosTotales, setObjetivosTotales] = useState([10, 20, 30, 40, 50]); // Datos iniciales
  ...
  useEffect(() => {
    ...
    // ✅ Inicializar el gráfico cuando el canvas esté disponible
    if (chartRef.current) {
          ...
          datasets: [
            {
              ...
              data: objetivosTotales, // Se actualiza con los datos de la API
